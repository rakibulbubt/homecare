...
(function(a, b) {
    ...
    function a(a) {
        ...
        g.destroyed && (g.destroyed = !1, a.options.container && l(a.options.container, function(a) {
            m(a, "scroll", g.validateT)
        }), m(window, "resize", g.saveViewportOffsetT), m(window, "resize", g.validateT), m(window, "scroll", g.validateT));
        b(a)
    }
    ...
    function b(a) {
        for (var g = a._util, c = 0; c < g.count; c++) {
            ...
            e.container && z && (t = t.closest(e.containerClass)) ? (t = t.getBoundingClientRect(), e = d(t, p) ? d(f, {
                top: t.top - e.offset,
        ...
        if (!u(a, c.successClass) && (b || c.loadInvisible ||
            ...
            if (b = a.getAttribute(w) || a.getAttribute(c.src)) {
                ...
                if (e || void 0 === a.src) {
                    ...
                    y && (r = a, l(b.getElementsByTagName("source"),
                        function(a) {
                            var b = c.srcset,
                                g = a.getAttribute(b);
            ...
            } else "video" === a.nodeName.toLowerCase() ? (l(a.getElementsByTagName("source"), function(a) {
                var b = c.src,
                    g = a.getAttribute(b);
                g && (a.setAttribute("src", g), a.removeAttribute(b))
            }), a.load(), f(a, c)) : (c.error && c.error(a, "missing"), q(a, c.errorClass))
    }
    ...
    return function(d) {
        ...
        c.load = function(a, b) {
            var c = this.options;
            void 0 === a.length ? e(a, b, c) : l(a, function(a) {
                e(a, b, c)
            })
        };
        c.destroy = function() {
        ...
        g.validateT = r(function() {
            b(c)
        }, c.options.validateDelay, c);
        g.saveViewportOffsetT = r(function() {
            v(c.options.offset)
...
function _grw_init_slider(a) {
    ...
    function f() {
        ...
        (2 > Math.abs(b.left - d.left) || b.left <= d.left) && d.left < b.right && (2 > Math.abs(b.right -
            d.right) || b.right >= d.right) && d.right > b.left ? q.scrollBy(-q.scrollWidth, 0) : e(1);
        m = setTimeout(f, u)
    }
    ...
    q && q.addEventListener("scroll", function() {
        setTimeout(d, 200);
        window.rplg_blazy && window.rplg_blazy.revalidate()
    });
    ...
    if (l = a.querySelector(".grw-slider-next")) l.onclick = function() {
        e(1);
        m && clearInterval(m)
    }
}
